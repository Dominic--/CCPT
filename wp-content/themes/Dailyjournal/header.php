...
<head>
	...
	<meta name="baidu-site-verification" content="ZGzN20oHju" />
							...
							if ($primaryNav == '') { ?>
								<ul class="<?php echo $menuClass; ?>">
									<?php if (get_option('dailyjournal_home_link') == 'on') { ?>
										<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php echo home_url(); ?>"><?php esc_html_e('Home','DailyJournal') ?></a></li>
									<?php }; ?>
